...
// State ordering matching the NFD flow
const MAIN_FLOW = [
  'Draft', 'AwaitingApplicant1Response', 'AwaitingApplicant2Response', 'Applicant2Approved',
  'AwaitingPayment', 'AwaitingHWFDecision', 'AwaitingDocuments', 'Submitted',
  'AwaitingService', 'AwaitingAos', 'AosDrafted', 'AosOverdue', 'OfflineDocumentReceived', 'AwaitingConditionalOrder',
  'Holding', 'ConditionalOrderPending', 'ConditionalOrderDrafted', 'AwaitingLegalAdvisorReferral',
  'LAReview', 'AwaitingPronouncement', 'ConditionalOrderPronounced',
  'AwaitingFinalOrder', 'FinalOrderRequested', 'FinalOrderPending', 'FinalOrderComplete'
];
...
const CASE_CREATION_IDS = new Set(['solicitor-create-application', 'citizen-create-application', 'create-draft-order']);
...
<text x="${svgW/2}" y="${PAD+10}" text-anchor="middle" font-size="14" font-weight="bold" font-family="Arial" fill="${HEADER_BG}">NFD CCD State &amp; Event Model</text>
