...
import static uk.gov.hmcts.divorce.solicitor.event.SolicitorAmendAlternativeServiceApplication.SOLICITOR_AMEND_ALTERNATIVE_SERVICE_APPLICATION;
import static uk.gov.hmcts.divorce.testutil.ConfigTestUtil.createCaseDataConfigBuilder;
import static uk.gov.hmcts.divorce.testutil.ConfigTestUtil.getEventsFrom;
import static uk.gov.hmcts.divorce.testutil.TestConstants.TEST_CASE_ID;

@ExtendWith(MockitoExtension.class)
class SolicitorAmendAlternativeServiceApplicationTest {

    @InjectMocks
    private SolicitorAmendAlternativeServiceApplication solicitorAmendAlternativeServiceApplication;

    @Mock
    private ServiceApplicationDraftSubmissionService serviceApplicationBuilderService;

    @Test
    void shouldAddSolicitorAmendAlternativeServiceApplicationEventToConfigBuilder() {
        final ConfigBuilderImpl<CaseData, State, UserRole> configBuilder = createCaseDataConfigBuilder();

        solicitorAmendAlternativeServiceApplication.configure(configBuilder);

        assertThat(getEventsFrom(configBuilder).values())
            .extracting(Event::getId)
            .contains(SOLICITOR_AMEND_ALTERNATIVE_SERVICE_APPLICATION);
    }
    ...
    void shouldSubmitFromInterimOptionsOnAboutToSubmit() {
        Applicant applicant = Applicant.builder()
            .interimApplicationOptions(InterimApplicationOptions.builder()
                .interimApplicationType(InterimApplicationType.ALTERNATIVE_SERVICE).build())
            .build();
        ...
        AboutToStartOrSubmitResponse<CaseData, State> response =
            solicitorAmendAlternativeServiceApplication.aboutToSubmit(caseDetails, caseDetails);
    ...
    void shouldReturnErrorInAboutToStartCallbackWhenPaymentReferenceIsPresent() {
        ...
        AboutToStartOrSubmitResponse<CaseData, State> response = solicitorAmendAlternativeServiceApplication.aboutToStart(details);
