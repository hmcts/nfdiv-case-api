...
class Applicant2SolicitorIntendsSwitchToSoleFoTest {
    ...
    void shouldReturnErrorIfCheckboxNotChecked() {
        ...
        AboutToStartOrSubmitResponse<CaseData, State> response =
            applicant2SolicitorIntendsSwitchToSoleFo.midEvent(details, details);
    ...
    void shouldNotReturnErrorIfCheckboxChecked() {
        ...
        final CaseData caseData = caseData();
        caseData.getFinalOrder().setApplicant2IntendsToSwitchToSole(Set.of(I_INTEND_TO_SWITCH_TO_SOLE));
