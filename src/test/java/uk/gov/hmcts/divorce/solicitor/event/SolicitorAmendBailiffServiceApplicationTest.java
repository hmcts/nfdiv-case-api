...
import static uk.gov.hmcts.divorce.solicitor.event.SolicitorAmendBailiffServiceApplication.SOLICITOR_AMEND_BAILIFF_SERVICE_APPLICATION;
...
class SolicitorAmendBailiffServiceApplicationTest {
    ...
    @InjectMocks
    private SolicitorAmendBailiffServiceApplication solicitorAmendBailiffServiceApplication;

    @Mock
    private ServiceApplicationDraftSubmissionService serviceApplicationBuilderService;

    @Test
    void shouldAddSolicitorAmendBailiffServiceApplicationEventToConfigBuilder() {
        final ConfigBuilderImpl<CaseData, State, UserRole> configBuilder = createCaseDataConfigBuilder();

        solicitorAmendBailiffServiceApplication.configure(configBuilder);

        assertThat(getEventsFrom(configBuilder).values())
            .extracting(Event::getId)
            .contains(SOLICITOR_AMEND_BAILIFF_SERVICE_APPLICATION);
    }
    ...
    void shouldSubmitFromInterimOptionsOnAboutToSubmit() {
        ...
        AboutToStartOrSubmitResponse<CaseData, State> response =
            solicitorAmendBailiffServiceApplication.aboutToSubmit(caseDetails, caseDetails);
