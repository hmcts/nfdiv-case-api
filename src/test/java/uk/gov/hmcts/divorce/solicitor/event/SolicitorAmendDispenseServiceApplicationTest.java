...
import static uk.gov.hmcts.divorce.solicitor.event.SolicitorAmendDispenseServiceApplication.SOLICITOR_AMEND_DISPENSE_WITH_SERVICE_APPLICATION;
import static uk.gov.hmcts.divorce.testutil.ConfigTestUtil.createCaseDataConfigBuilder;
import static uk.gov.hmcts.divorce.testutil.ConfigTestUtil.getEventsFrom;
import static uk.gov.hmcts.divorce.testutil.TestConstants.TEST_CASE_ID;

@ExtendWith(MockitoExtension.class)
class SolicitorAmendDispenseServiceApplicationTest {

    @InjectMocks
    private SolicitorAmendDispenseServiceApplication solicitorAmendDispenseServiceApplication;

    @Mock
    private ServiceApplicationDraftSubmissionService serviceApplicationBuilderService;

    @Test
    void shouldAddSolicitorAmendDispenseServiceApplicationEventToConfigBuilder() {
        final ConfigBuilderImpl<CaseData, State, UserRole> configBuilder = createCaseDataConfigBuilder();

        solicitorAmendDispenseServiceApplication.configure(configBuilder);

        assertThat(getEventsFrom(configBuilder).values())
            .extracting(Event::getId)
            .contains(SOLICITOR_AMEND_DISPENSE_WITH_SERVICE_APPLICATION);
    }
    ...
    void shouldSubmitFromInterimOptionsOnAboutToSubmit() {
        ...
        AboutToStartOrSubmitResponse<CaseData, State> response =
            solicitorAmendDispenseServiceApplication.aboutToSubmit(caseDetails, caseDetails);
    ...
    void shouldReturnErrorInAboutToStartCallbackWhenPaymentReferenceIsPresent() {
        ...
        AboutToStartOrSubmitResponse<CaseData, State> response = solicitorAmendDispenseServiceApplication.aboutToStart(details);
