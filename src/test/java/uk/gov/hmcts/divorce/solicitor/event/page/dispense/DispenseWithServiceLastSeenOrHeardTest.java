...
public class DispenseWithServiceLastSeenOrHeardTest {

    @InjectMocks
    private DispenseWithServiceLastSeenOrHeard page;
    ...
    void shouldReturnErrorWhenLastSeenOrHeardDateEnteredIsInFuture() {
        ...
        caseData.getApplicant1().getInterimApplicationOptions().getDispenseWithServiceJourneyOptions()
            .setDispensePartnerLastSeenDate(LocalDate.of(2027, 1, 1));
    ...
    @Test
    void shouldSetDispensePartnerLastSeenOver2YearsAgoField() {
        final CaseData caseData = caseData();
        caseData.getApplicant1().setInterimApplicationOptions(InterimApplicationOptions.builder().build());
        caseData.getApplicant1().getInterimApplicationOptions().setDispenseWithServiceJourneyOptions(
            DispenseWithServiceJourneyOptions.builder().build());
        caseData.getApplicant1().getInterimApplicationOptions().getDispenseWithServiceJourneyOptions()
            .setDispensePartnerLastSeenDate(LocalDate.of(2022, 1, 1));
        ...
        assertThat(response.getData().getApplicant1().getInterimApplicationOptions().getDispenseWithServiceJourneyOptions()
            .getDispensePartnerLastSeenOver2YearsAgo()).isEqualTo(YesOrNo.YES);
    }
}
