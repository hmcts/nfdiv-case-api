...
import static uk.gov.hmcts.divorce.solicitor.event.SolicitorDispenseWithServiceApplication.SOLICITOR_DISPENSE_WITH_SERVICE_APPLICATION;
import static uk.gov.hmcts.divorce.testutil.ConfigTestUtil.createCaseDataConfigBuilder;
import static uk.gov.hmcts.divorce.testutil.ConfigTestUtil.getEventsFrom;
import static uk.gov.hmcts.divorce.testutil.TestConstants.TEST_CASE_ID;

@ExtendWith(MockitoExtension.class)
class SolicitorDispenseWithServiceApplicationTest {

    @InjectMocks
    private SolicitorDispenseWithServiceApplication solicitorDispenseWithServiceApplication;
    ...
    void shouldAddSolicitorDeemedServiceApplicationEventToConfigBuilder() {
        ...
        assertThat(getEventsFrom(configBuilder).values())
            ...
            .contains(SOLICITOR_DISPENSE_WITH_SERVICE_APPLICATION);
    }
    ...
    @Test
    void shouldSetInterimApplicationTypeToDispenseWithServiceAndSubmitFromInterimOptionsOnAboutToSubmit() {
        ...
        AboutToStartOrSubmitResponse<CaseData, State> response =
            solicitorDispenseWithServiceApplication.aboutToSubmit(caseDetails, caseDetails);

        assertThat(options.getInterimApplicationType()).isEqualTo(InterimApplicationType.DISPENSE_WITH_SERVICE);
