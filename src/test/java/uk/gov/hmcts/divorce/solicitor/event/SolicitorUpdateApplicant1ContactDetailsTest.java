...
public class SolicitorUpdateApplicant1ContactDetailsTest {
    ...
    void shouldAddConfigurationToConfigBuilder() {
        ...
        SolicitorUpdateApplicant1ContactDetails solicitorUpdateApplicant1ContactDetails = new SolicitorUpdateApplicant1ContactDetails(
            new UpdateApplicant1ContactDetails(), new ProcessConfidentialDocumentsService()
        );
