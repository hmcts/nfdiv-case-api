...
public final class TestConstants {
    ...
    public static final String TEST_DIVORCE_APPLICATION_SOLE_TEMPLATE_ID = "NFD_CP_Application_Sole_V6.docx";
    public static final String TEST_DIVORCE_APPLICATION_JOINT_TEMPLATE_ID = "NFD_CP_Application_Joint_V5.docx";

    public static final String TEST_FINANCIAL_ORDER_POLICY_HEADER = "The applicant wants to apply for a financial order.";
