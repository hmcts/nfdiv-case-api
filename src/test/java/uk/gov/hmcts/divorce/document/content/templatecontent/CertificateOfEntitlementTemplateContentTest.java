    ...
    void shouldProvideCorrectTemplateContentForRepresentedCertificateOfEntitlementCoverLetter() {
        ...
        assertThat(templateContent).containsAllEntriesOf(
            Map.of(
                ...
                SOLICITOR_ADDRESS, "Address(addressLine1=sol line1, addressLine2=sol line2, addressLine3=null, postTown=sol city, county=null, postCode=sol postcode, country=null)",
