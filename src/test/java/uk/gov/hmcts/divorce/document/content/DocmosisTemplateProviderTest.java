...
class DocmosisTemplateProviderTest {
    ...
    void shouldReturnTemplateForEnglish() {
        ...
        final String name = docmosisTemplateProvider.templateNameFor(DIVORCE_MINI_DRAFT_APPLICATION, ENGLISH);
    ...
    void shouldReturnTemplateForWelsh() {
        ...
        final String name = docmosisTemplateProvider.templateNameFor(DIVORCE_MINI_DRAFT_APPLICATION, WELSH);
