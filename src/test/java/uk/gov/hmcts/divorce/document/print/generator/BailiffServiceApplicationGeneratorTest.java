...
class BailiffServiceApplicationGeneratorTest {
    @Mock
    ...
    void shouldRenderDocumentWithBailiffTemplateVariables() {
        ...
        DivorceDocument result = bailiffServiceApplicationGenerator.generateDocument(
        ...
        assertThat(result.getDocumentType()).isEqualTo(BAILIFF_SERVICE);
