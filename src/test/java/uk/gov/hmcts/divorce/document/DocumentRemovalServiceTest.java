...
public class DocumentRemovalServiceTest {
    ...
    public void shouldRemoveDraftApplicationDocumentFromCaseDataAndDeleteApplicationDocumentFromDocManagement() {
        ...
        final ListValue<DivorceDocument> divorceDocumentListValue = documentWithType(CONDITIONAL_ORDER_GRANTED);
    ...
    public void shouldThrow403ForbiddenWhenServiceIsNotWhitelistedInDocManagement() {
        ...
        assertThatThrownBy(() -> documentRemovalService.deleteDocumentFromDocumentStore(
            singletonList(documentWithType(CONDITIONAL_ORDER_GRANTED)),
            CONDITIONAL_ORDER_GRANTED,
            TEST_CASE_ID
        ))
