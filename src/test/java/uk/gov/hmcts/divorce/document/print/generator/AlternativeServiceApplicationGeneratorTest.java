...
class AlternativeServiceApplicationGeneratorTest {
    @Mock
    ...
    void shouldRenderDocumentWithDeemedTemplateVariables() {
        ...
        DivorceDocument result = alternativeServiceApplicationGenerator.generateDocument(
        ...
        assertThat(result.getDocumentType()).isEqualTo(ALTERNATIVE_SERVICE);
