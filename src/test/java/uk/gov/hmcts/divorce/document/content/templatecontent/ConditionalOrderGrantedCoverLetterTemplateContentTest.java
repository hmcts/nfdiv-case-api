...
class ConditionalOrderGrantedCoverLetterTemplateContentTest {
    ...
    public void shouldProvideCorrectTemplateContentForCOGrantedCoverLetter() {
        ...
        final var templateContent = conditionalOrderGrantedCoverLetterTemplateContent.getTemplateContent(
            caseData,
            TEST_CASE_ID,
