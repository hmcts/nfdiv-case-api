...
import static uk.gov.hmcts.divorce.caseworker.event.CaseworkerUpdateRefundDueDate.CASEWORKER_UPDATE_REFUND_DUE_DATE;
...
class CaseworkerUpdateRefundDueDateTest {
    ...
    void shouldAddConfigurationToConfigBuilder() {
        ...
        assertThat(getEventsFrom(configBuilder).values())
            ...
            .contains(CASEWORKER_UPDATE_REFUND_DUE_DATE);
    }
}
