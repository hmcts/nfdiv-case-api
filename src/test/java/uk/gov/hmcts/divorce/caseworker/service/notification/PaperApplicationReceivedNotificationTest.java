...
import static uk.gov.hmcts.divorce.caseworker.service.notification.PaperApplicationReceivedNotification.APPLICANT1_DOCUMENT_NAME;
import static uk.gov.hmcts.divorce.caseworker.service.notification.PaperApplicationReceivedNotification.APPLICANT2_DOCUMENT_NAME;
    ...
    void testSendToApplicant1Offline() {
        ...
        verify(caseDataDocumentService)
                .renderDocument(
                        ...
                        TEST_CASE_ID,
                        PAPER_APPLICATION_RECEIVED_TEMPLATE_ID,
                        ENGLISH, APPLICANT1_DOCUMENT_NAME);
    }
    ...
    void testSendToApplicant2Offline() {
        ...
        verify(caseDataDocumentService)
            .renderDocument(
                ...
                TEST_CASE_ID,
                PAPER_APPLICATION_RECEIVED_TEMPLATE_ID,
                WELSH, APPLICANT2_DOCUMENT_NAME);
    }
