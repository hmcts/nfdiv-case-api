...
import static uk.gov.hmcts.divorce.caseworker.event.CaseworkerUpdateOfflineStatus.CASEWORKER_UPDATE_OFFLINE_STATUS;
...
public class CaseworkerUpdateOfflineStatusTest {
    ...
    void shouldAddConfigurationToConfigBuilder() throws Exception {
        ...
        assertThat(getEventsFrom(configBuilder).values())
            ...
            .contains(CASEWORKER_UPDATE_OFFLINE_STATUS);
    }
}
