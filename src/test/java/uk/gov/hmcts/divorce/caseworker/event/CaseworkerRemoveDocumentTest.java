    ...
    void shouldRemoveApplicant1UploadedDocument() {
        ...
        CaseData beforeCaseData = CaseData.builder()
            .documents(CaseDocuments.builder()
                .applicant1DocumentsUploaded(List.of(doc1, doc2)).build())
            .build();
        ...
        caseworkerRemoveDocument.aboutToSubmit(beforeDetails, currentDetails);
        ...
        verify(documentManagementClient).deleteDocument(
            ...
            SYSTEM_USER_USER_ID,
            doc2.getValue().getDocumentLink().getUrl(),
            true
        );
    }
}
