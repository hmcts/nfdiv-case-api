...
class AosPackPrinterTest {
    ...
    @Test
    void shouldPrintAosPackForApplicantJointJudicialSeparation() {
        ...
        final CaseData caseData = CaseData.builder()
            ...
            .documents(CaseDocuments.builder()
                .documentsGenerated(List.of(doc1, doc2, doc3, doc4))
                .build())
            .build();
    ...
    @Test
    void shouldPrintAosPackForRespondentJointJudicialSeparation() {

        final ListValue<DivorceDocument> doc1 = ListValue.<DivorceDocument>builder()
            .value(DivorceDocument.builder()
                .documentType(COVERSHEET)
                .documentFileName("coversheet-1669298408633097-applicant2-2022-11-25:11:12.pdf")
                .build())
            .build();
