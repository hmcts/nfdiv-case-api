...
public class SwitchToSoleServiceTest {
    ...
    @Test
    void shouldFailOnCaseAssignmentApiExceptionWhenSwitchingSolicitorUserRoles() throws FeignException {
        final long caseId = TEST_CASE_ID;
        final CaseData caseData = CaseData.builder()
            .applicant1(
                Applicant.builder()
    ...
    @Test
    void shouldFailOnCaseAssignmentApiExceptionWhenSwitchingCitizenAndSolicitorUserRoles() throws FeignException {
        final long caseId = TEST_CASE_ID;
        final CaseData caseData = CaseData.builder()
            .applicant1(
                Applicant.builder()
