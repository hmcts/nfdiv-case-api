...
public class CitizenConfirmServicePaymentTest {
    ...
    void shouldReturnCaseData() {
        ...
        AboutToStartOrSubmitResponse<CaseData, State> response = citizenAlternativeServicePayment.aboutToStart(details);
    ...
    void shouldReturnState() {
        ...
        AboutToStartOrSubmitResponse<CaseData, State> response = citizenAlternativeServicePayment.aboutToSubmit(details, details);
