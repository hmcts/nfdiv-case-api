...
public class ApplicationIssuedNotificationTest {
    ...
    void shouldSendNotificationToApplicantSolicitor() {
        ...
        when(commonContent.basicTemplateVars(caseData, TEST_CASE_ID, caseData.getApplicant1())).thenReturn(commonTemplateVars());
    ...
    void shouldSendNotificationToRespondentSolicitorIfSoleApplicationAndNotSolicitorServiceWithoutSolicitorReference() {
        ...
        when(commonContent.basicTemplateVars(caseData, TEST_CASE_ID, caseData.getApplicant2())).thenReturn(commonTemplateVars());
