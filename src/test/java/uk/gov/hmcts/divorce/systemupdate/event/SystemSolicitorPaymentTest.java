...
public class SystemSolicitorPaymentTest {
    ...
    @InjectMocks
    private SystemSolicitorPayment systemSolicitorPayment;
    ...
    void shouldAddPaymentIfPaymentsExists() {
        ...
        final AboutToStartOrSubmitResponse<CaseData, State> response =
            systemSolicitorPayment.aboutToSubmit(caseDetails, new CaseDetails<>());
