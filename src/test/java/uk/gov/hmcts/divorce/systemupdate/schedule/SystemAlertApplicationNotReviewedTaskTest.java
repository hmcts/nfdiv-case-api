...
public class SystemAlertApplicationNotReviewedTaskTest {
    ...
    void shouldSendEmailForOverdueJointApplication() {
        ...
        final CaseData caseData2 = CaseData.builder().dueDate(LocalDate.now()).build();

        when(caseDetails1.getData()).thenReturn(Map.of("dueDate", LocalDate.now()));
        when(caseDetails1.getId()).thenReturn(1L);
        when(caseDetails2.getData()).thenReturn(Map.of("dueDate", LocalDate.now()));
        ...
        when(mapper.convertValue(Map.of("dueDate", LocalDate.now()), CaseData.class)).thenReturn(caseData2);
        ...
        verify(jointApplicationOverdueNotification).sendApplicationNotReviewedEmail(caseData2, caseDetails2.getId());
