...
@Component
@Slf4j
public class Applicant2CoOverdueSwitchToSoleNotification implements ApplicantNotification {
    ...
    public void sendToApplicant2Solicitor(final CaseData caseData, final Long id) {
        log.info("Notifying applicant2 solicitor they can apply for switch to sole (Conditional order overdue) for application {} is overdue", id);
