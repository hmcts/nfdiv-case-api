    ...
    public void addTo(PageBuilder pageBuilder) {
        ...
        pageBuilder
            ...
            .complex(CaseData::getConditionalOrder)
                ...
                .done()
            .done()
            .label("withdrawLabelApp2", "If you want to withdraw this joint application then both parties need to jointly fill out a <a href=\"https://www.gov.uk/government/publications/form-d11-application-notice\" target=\"_blank\" rel=\"noopener noreferrer\">D11 form</a> and send it to the court. Details of where to send it are on the form.")
            .label("firstInTimeApp2",
                "<details>"
                    + "<summary>"
                    + "<span>"
                    ...
                    + "</summary>"
                    + "<div>"
                    + "<p>If you want to progress the application but you do not think the other party will confirm the joint application "
                    + "for a conditional order, then you can change to a sole application. "
                    + "This means the other party will become the respondent.</p>"
                    + "<p>You should still continue to draft and submit a joint conditional order application. "
            ...
            .label("secondInTimeApp2",
                "<details>"
                    ...
                    + "</summary>"
                    + "<div>"
                    + "<p>The other applicant has already confirmed they want to continue with the joint application. "
                    + "The quickest way for you to progress the ${labelContentDivorceOrEndingCivilPartnership} is for you to also confirm "
                    + "you want to continue with the joint application.</p>"
                    + "<p>"
                    ...
                    + "is to confirm you want to continue with the joint application.</p>"
                    + "</div>"
                    + "</details>"
                    + "<br>", "coApplicant1ConfirmInformationStillCorrect=\"*\"")
            .done()
