...
public class CitizenGenerateD10 implements CCDConfig<CaseData, State, UserRole> {

    public static final String CITIZEN_GENERATE_D10 = "citizen-generate-d10";
    ...
    public void configure(final ConfigBuilder<CaseData, State, UserRole> configBuilder) {
        ...
        configBuilder
            .event(CITIZEN_GENERATE_D10)
            .forStates(CITIZEN_UPDATE_STATES)
            .showCondition(NEVER_SHOW)
            .name("Citizen Generate D10")
            .description("Citizen event to generate D10 form")
