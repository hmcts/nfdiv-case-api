...
@Data
public class InferredPetitionerGender {

    private static final String BLANK_SPACE = " ";
    private static final String ACTUAL_DATA = "Actual data is: %s";
    private static final String ERROR_MESSAGE = "InferredPetitionerGender can not be null or empty.";
    ...
    @When
    public boolean when() {
        return !Optional.ofNullable(coreCaseData.getInferredPetitionerGender()).isPresent();
    }
