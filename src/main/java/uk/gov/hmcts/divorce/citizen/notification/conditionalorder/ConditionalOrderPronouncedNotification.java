    ...
    private Map<String, String> templateVars(final CaseData caseData,
        ...
        if (isNull(conditionalOrder.getCourt())) {
            throw new NotificationTemplateException(
                format(MISSING_FIELD_MESSAGE, "coCourt", caseId));
        }
        if (isNull(conditionalOrder.getDateAndTimeOfHearing())) {
            throw new NotificationTemplateException(
                format(MISSING_FIELD_MESSAGE, "coDateAndTimeOfHearing", caseId));
        }
        if (isNull(conditionalOrder.getGrantedDate())) {
            throw new NotificationTemplateException(
                format(MISSING_FIELD_MESSAGE, "coGrantedDate", caseId));
        }
