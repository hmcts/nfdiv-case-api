...
import static uk.gov.hmcts.divorce.notification.EmailTemplateName.D11_GENERAL_APPLICATION_AWAITING_DOCUMENTS;
import static uk.gov.hmcts.divorce.notification.EmailTemplateName.D11_GENERAL_APPLICATION_SUBMITTED;
import static uk.gov.hmcts.divorce.notification.FormatUtil.getDateTimeFormatterForPreferredLanguage;

@Component
@Slf4j
@RequiredArgsConstructor
public class D11GeneralApplicationSubmittedNotification implements ApplicantNotification {
    ...
    public void sendToApplicant1(final CaseData caseData, final Long caseId, GeneralApplication generalApplication) {
        ...
        notificationService.sendEmail(
            ...
            paidByHwf ? D11_GENERAL_APPLICATION_AWAITING_DOCUMENTS : D11_GENERAL_APPLICATION_SUBMITTED,
