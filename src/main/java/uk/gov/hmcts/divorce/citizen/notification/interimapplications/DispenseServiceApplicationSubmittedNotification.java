...
public class DispenseServiceApplicationSubmittedNotification implements ApplicantNotification {
    ...
    public void sendToApplicant1(final CaseData caseData, final Long caseId) {
        log.info("Sending dispense service application submitted notification to applicant 1 on case id {}", caseId);
        ...
        notificationService.sendEmail(
            ...
            awaitingDocuments ? DISPENSE_SERVICE_APPLICATION_AWAITING_DOCUMENTS : DISPENSE_SERVICE_APPLICATION_SUBMITTED,
