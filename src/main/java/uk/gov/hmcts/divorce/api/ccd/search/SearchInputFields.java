...
import static uk.gov.hmcts.divorce.api.ccd.search.constants.CaseFieldsConstants.EMAIL;
import static uk.gov.hmcts.divorce.api.ccd.search.constants.CaseFieldsConstants.FIRSTNAME;
import static uk.gov.hmcts.divorce.api.ccd.search.constants.CaseFieldsConstants.LASTNAME;
import static uk.gov.hmcts.divorce.api.ccd.search.constants.CaseFieldsConstants.PETITIONER_EMAIL;
import static uk.gov.hmcts.divorce.api.ccd.search.constants.CaseFieldsConstants.PETITIONER_FIRST_NAME;
import static uk.gov.hmcts.divorce.api.ccd.search.constants.CaseFieldsConstants.PETITIONER_LAST_NAME;
