...
@Component
@Slf4j
public class MiniApplicationTemplateContent {
    ...
    public Supplier<Map<String, Object>> apply(final CaseData caseData,
        ...
        return () -> {
            ...
            templateData.put(COURT_CASE_DETAILS, caseData.getApplication().getApplicant1LegalProceedingsDetails());
            templateData.put(HAS_OTHER_COURT_CASES, caseData.getApplication().getApplicant1LegalProceedings().toBoolean());
