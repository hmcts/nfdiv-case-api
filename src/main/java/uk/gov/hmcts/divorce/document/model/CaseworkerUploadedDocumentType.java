...
@Getter
@AllArgsConstructor
public enum CaseworkerUploadedDocumentType implements HasLabel {
    ...
    MARRIAGE_CERT_TRANSLATION("Marriage certificate translation"),

    @JsonProperty("nameChange")
    NAME_CHANGE("Name change evidence"),
