...
public class RequestForInformationPartnerResponseDocumentPack implements DocumentPack {
    ...
    public DocumentPackInfo getDocumentPack(final CaseData caseData, final Applicant applicant) {
        return applicant.isRepresented()
            ? SOLICITOR_REQUEST_FOR_INFORMATION_PARTNER_RESPONSE_PACK
            : APPLICANT_REQUEST_FOR_INFORMATION_PARTNER_RESPONSE_PACK;
    }
