...
public class ApplyForFinalOrderDocumentPack implements DocumentPack {
    ...
    private static final DocumentPackInfo APPLICANT1_OFFLINE_DOCUMENTPACK = new DocumentPackInfo(
        ImmutableMap.of(
    ...
    private static final DocumentPackInfo APPLICANT2_OFFLINE_DOCUMENTPACK = new DocumentPackInfo(
        ImmutableMap.of(
            COVERSHEET, Optional.of(COVERSHEET_APPLICANT),
    ...
    public DocumentPackInfo getDocumentPack(CaseData caseData, Applicant applicant) {
        return caseData.getApplicant1().equals(applicant) ? APPLICANT1_OFFLINE_DOCUMENTPACK : APPLICANT2_OFFLINE_DOCUMENTPACK;
    }
