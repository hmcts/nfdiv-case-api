...
public class ConditionalOrderRefusalDocumentPack implements DocumentPack {
    ...
    private static final DocumentPackInfo AMENDMENT_JS_SOL_PACK = new DocumentPackInfo(Map.of(
    ...
    private static final DocumentPackInfo AMENDMENT_PACK = new DocumentPackInfo(Map.of(
        COVERSHEET, Optional.of(COVERSHEET_APPLICANT),
    ...
    private static final DocumentPackInfo AMENDMENT_SEPARATION_PACK = new DocumentPackInfo(Map.of(
        COVERSHEET, Optional.of(COVERSHEET_APPLICANT),
        JUDICIAL_SEPARATION_ORDER_REFUSAL_COVER_LETTER, Optional.of(JUDICIAL_SEPARATION_ORDER_REFUSAL_COVER_LETTER_TEMPLATE_ID),
        CONDITIONAL_ORDER_REFUSAL, Optional.empty(),
        APPLICATION, Optional.empty()
    ...
    private static final DocumentPackInfo AMENDMENT_SOL_SEPARATION_PACK = new DocumentPackInfo(Map.of(
        COVERSHEET, Optional.of(COVERSHEET_APPLICANT2_SOLICITOR),
    ...
    private static final DocumentPackInfo CLARIFICATION_JS_PACK = new DocumentPackInfo(Map.of(
        COVERSHEET, Optional.of(COVERSHEET_APPLICANT),
    ...
    private static final DocumentPackInfo CLARIFICATION_SEPARATION_PACK = new DocumentPackInfo(Map.of(
        COVERSHEET, Optional.of(COVERSHEET_APPLICANT),
    ...
    private static final DocumentPackInfo CLARIFICATION_SOL_SEPARATION_PACK = new DocumentPackInfo(Map.of(
        COVERSHEET, Optional.of(COVERSHEET_APPLICANT2_SOLICITOR),
    ...
    private static final DocumentPackInfo CLARIFICATION_SOL_JS_PACK = new DocumentPackInfo(Map.of(
        COVERSHEET, Optional.of(COVERSHEET_APPLICANT2_SOLICITOR),
    ...
    private static final DocumentPackInfo CLARIFICATION_PACK = new DocumentPackInfo(Map.of(
        COVERSHEET, Optional.of(COVERSHEET_APPLICANT),
