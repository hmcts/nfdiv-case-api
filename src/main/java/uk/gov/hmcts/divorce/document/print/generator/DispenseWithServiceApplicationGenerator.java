...
@Slf4j
public class DispenseWithServiceApplicationGenerator {
    private final CaseDataDocumentService caseDataDocumentService;
    private final DispenseWithServiceApplicationTemplateContent templateContent;

    public DivorceDocument generateDocument(final long caseId,
                                      final Applicant applicant,
                                      final CaseData caseData) {
        log.info("Generating dispense with service application document for {}", caseId);
        ...
        return DivorceDocument
          ...
          .documentType(DISPENSE_WITH_SERVICE)
