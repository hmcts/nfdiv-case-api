...
public final class DocmosisTemplateConstants {
    ...
    public static final String DIVORCE_APPLICATION_CY = "cais am ysgariad";
    ...
    public static final String THE_DIVORCE_CY = "ysgariad";
    ...
    public static final String PHONE_AND_OPENING_TIMES_TEXT_CY = "Ffôn: 0300 303 5171 (Dydd Llun i ddydd Iau 9am i 5pm, Dydd Gwener 9am to 4.30pm)";
