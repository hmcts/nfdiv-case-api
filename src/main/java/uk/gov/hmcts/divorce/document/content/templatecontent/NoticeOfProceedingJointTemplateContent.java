...
import static uk.gov.hmcts.divorce.document.content.templatecontent.NoticeOfProceedingSoleTemplateContent.APPLICATION_TO_END_YOUR_CIVIL_PARTNERSHIP_CY;
import static uk.gov.hmcts.divorce.document.content.templatecontent.NoticeOfProceedingSoleTemplateContent.PROCEEDINGS_TO_END_YOUR_CIVIL_PARTNERSHIP_CY;
import static uk.gov.hmcts.divorce.document.content.templatecontent.NoticeOfProceedingSoleTemplateContent.TO_END_YOUR_CIVIL_PARTNERSHIP_CY;
    ...
    public Map<String, Object> getTemplateContent(final CaseData caseData,
        ...
        if (caseData.getDivorceOrDissolution().isDivorce()) {
            ...
            templateContent.put(DIVORCE_OR_CIVIL_PARTNERSHIP_PROCEEDINGS,
                WELSH.equals(applicantLanguagePreference) ? A_DIVORCE_APPLICATION_CY : DIVORCE_PROCEEDINGS);
