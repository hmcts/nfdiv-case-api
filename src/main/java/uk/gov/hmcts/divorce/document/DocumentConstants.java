...
public final class DocumentConstants {
    ...
    public static final String NOTICE_OF_PROCEEDINGS_JOINT_SOLICITOR_TEMPLATE_ID = "NOTICE_OF_PROCEEDINGS_JOINT_SOLICITOR";
    ...
    public static final String DIVORCE_GENERAL_ORDER_V2 = "DIVORCE_GENERAL_ORDER_V2";
