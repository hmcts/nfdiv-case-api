...
public final class DocumentConstants {
    ...
    public static final String RESPONDENT_RESPONDED_DISPUTED_CO_TEMPLATE_ID = "NFD_RESP_RESPONDED_DISPUTED_CO";
    public static final String RESPONDENT_RESPONDED_UNDEFENDED_TEMPLATE_ID = "NFD_RESP_RESPONDED_UNDEFENDED";
    public static final String RESPONDENT_RESPONDED_UNDEFENDED_CO_TEMPLATE_ID = "NFD_RESP_RESPONDED_UNDEFENDED_CO";
