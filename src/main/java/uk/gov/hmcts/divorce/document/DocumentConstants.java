...
public final class DocumentConstants {
    ...
    public static final String DIVORCE_APPLICATION_DOCUMENT_NAME_REG = "regenerated-divorce-application";
    ...
    public static final String JUDICIAL_SEPARATION_APPLICATION_DOCUMENT_NAME_REG = "regenerated-judicial-separation-application";
    ...
    public static final String CO_GRANTED_SOL_COVER_LETTER_TEMPLATE_ID = "CO_GRANTED_SOL_COVER_LETTER";
    public static final String CO_PRONOUNCED_COVER_LETTER_OFFLINE_RESPONDENT_SOL_TEMPLATE_ID
        = "CO_PRONOUNCED_SOL_COVER_LETTER_OFFLINE_RESPONDENT";
    ...
    public static final String FINAL_ORDER_CAN_APPLY_RESPONDENT_TEMPLATE_ID = "FINAL_ORDER_CAN_APPLY_RESPONDENT";
    ...
    public static final String REQUEST_FOR_INFORMATION_PARTNER_RESPONSE_LETTER_TEMPLATE_ID = "REQUEST_FOR_INFORMATION_PARTNER_RESPONSE_LETTER";
    ...
    public static final String REQUEST_FOR_INFORMATION_SOLICITOR_RESPONSE_LETTER_DOCUMENT_NAME = "RequestForInformationSolicitorResponseLetter";
    public static final String REQUEST_FOR_INFORMATION_SOLICITOR_RESPONSE_LETTER_TEMPLATE_ID = "REQUEST_FOR_INFORMATION_SOLICITOR_RESPONSE_LETTER";
    public static final String REQUEST_FOR_INFORMATION_PARTNER_SOLICITOR_RESPONSE_LETTER_DOCUMENT_NAME = "RequestForInformationPartnerSolicitorResponseLetter";
    public static final String REQUEST_FOR_INFORMATION_PARTNER_SOLICITOR_RESPONSE_LETTER_TEMPLATE_ID = "REQUEST_FOR_INFORMATION_PARTNER_SOLICITOR_RESPONSE_LETTER";
