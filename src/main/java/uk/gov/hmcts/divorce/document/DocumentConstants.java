...
public final class DocumentConstants {
    ...
    public static final String JUDICIAL_SEPARATION_ORDER_GRANTED_SOLICITOR_COVERSHEET_DOCUMENT_NAME = "judicialSeparationOrderGrantedSolicitorCoversheet";
    ...
    public static final String JUDICIAL_SEPARATION_ORDER_GRANTED_COVER_LETTER_TEMPLATE_ID = "JUDICIAL_SEPARATION_ORDER_GRANTED_COVER_LETTER";
    public static final String JUDICIAL_SEPARATION_ORDER_GRANTED_SOLICITOR_COVER_LETTER_TEMPLATE_ID = "JUDICIAL_SEPARATION_ORDER_GRANTED_SOLICITOR_COVER_LETTER";
