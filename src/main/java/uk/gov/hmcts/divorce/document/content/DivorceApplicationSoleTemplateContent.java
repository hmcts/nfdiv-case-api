    ...
    public Supplier<Map<String, Object>> apply(final CaseData caseData,
        ...
        return () -> {
            ...
            if (caseData.getDivorceOrDissolution().isDivorce()) {
                templateData.put(CONDITIONAL_ORDER_DIVORCE_OR_CIVIL_PARTNERSHIP, "for a final order of divorce from");
                ...
                templateData.put(CONDITIONAL_ORDER_DIVORCE_OR_CIVIL_PARTNERSHIP, "for the dissolution of the civil partnership with");
                templateData.put(DIVORCE_OR_DISSOLUTION, "application to end your civil partnership");
            ...
            if (null != applicant1.getFinancialOrder()) {
                ...
                templateData.put(APPLICANT_1_FINANCIAL_ORDER, applicantTemplateDataProvider.deriveSoleFinancialOrder(applicant1));
            }
            ...
            templateData.put("jurisdictions", applicationTemplateDataProvider.deriveSoleJurisdictionList(application, caseId));
