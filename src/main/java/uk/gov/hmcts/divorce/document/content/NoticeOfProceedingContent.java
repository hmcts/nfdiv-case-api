...
public class NoticeOfProceedingContent {
    ...
    public static final String IS_RESPONDENT_EMAIL_PRESENT = "isRespondentEmailPresent";
    ...
    public Map<String, Object> apply(final CaseData caseData,
        ...
        templateContent.put(ADD_FO_LETTER_CONTENT, shouldGenerateFinancialOrderLetter(caseData));
