...
public class CaseworkerRejectServiceApplication implements CCDConfig<CaseData, State, UserRole> {
    public static final String CASEWORKER_WITHDRAWN = "caseworker-reject-service-app";
    ...
    public void configure(final ConfigBuilder<CaseData, State, UserRole> configBuilder) {
        new PageBuilder(configBuilder
            ...
            .forStateTransition(POST_SUBMISSION_STATES, AosOverdue)
            .name("Reject service application")
            .description("Reject service application")
            .showEventNotes()
    ...
    public AboutToStartOrSubmitResponse<CaseData, State> aboutToSubmit(final CaseDetails<CaseData, State> details,
        ...
        details.getData().setAlternativeService(AlternativeService.builder().build());
