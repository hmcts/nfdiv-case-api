...
public class CaseFlagsService {
    ...
    public void initialiseCaseFlags(CaseData caseData) {
    ...
    public void initialisePartyGroupIds(CaseData caseData) {
    ...
    public void initialiseAllInternalPartyFlags(CaseData caseData) {
