...
@Component
public class CaseworkerUpdateApplicationType implements CCDConfig<CaseData, State, UserRole> {
    public static final String CASEWORKER_UPDATE_APPLICATION_TYPE = "caseworker-update-application-type";

    @Override
    public void configure(final ConfigBuilder<CaseData, State, UserRole> configBuilder) {
        new PageBuilder(configBuilder
            .event(CASEWORKER_UPDATE_APPLICATION_TYPE)
            .forAllStates()
