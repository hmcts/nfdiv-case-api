...
public class CaseworkerUpdateContactDetails implements CCDConfig<CaseData, State, UserRole> {
    ...
    public void configure(final ConfigBuilder<CaseData, State, UserRole> configBuilder) {
        ...
        pageDetails(pageBuilder);
    }

    private void pageDetails(PageBuilder pageBuilder) {
        FieldCollection.FieldCollectionBuilder<CaseData, State, Event.EventBuilder<CaseData, UserRole, State>> fieldCollectionBuilder
            = pageBuilder.page("UpdateContactDetails");

        FieldCollection.FieldCollectionBuilder<CaseData, State, Event.EventBuilder<CaseData, UserRole, State>> applicantFieldBuilder
            = getApplicantFieldBuilder(fieldCollectionBuilder);
        FieldCollection.FieldCollectionBuilder<CaseData, State, Event.EventBuilder<CaseData, UserRole, State>> respondentFieldBuilder
            = getRespFieldBuilder(applicantFieldBuilder);

        respondentFieldBuilder.label("Label-UpdateMarriageCertWarning",
    ...
    private FieldCollection.FieldCollectionBuilder<CaseData, State, Event.EventBuilder<CaseData, UserRole, State>> getApplicantFieldBuilder(
        FieldCollection.FieldCollectionBuilder<CaseData, State, Event.EventBuilder<CaseData, UserRole, State>> fieldCollectionBuilder) {

        return fieldCollectionBuilder.complex(CaseData::getApplicant1)
    ...
    private FieldCollection.FieldCollectionBuilder<CaseData, State, Event.EventBuilder<CaseData, UserRole, State>> getRespFieldBuilder(
        FieldCollection.FieldCollectionBuilder<CaseData, State, Event.EventBuilder<CaseData, UserRole, State>> applicantFieldBuilder) {

        return applicantFieldBuilder.complex(CaseData::getApplicant2)
            .optional(Applicant::getFirstName,
                null,
                null,
