    ...
    private void buildApplicant1Fields(
        ...
        fieldCollectionBuilder
            ...
            .complex(CaseData::getApplicant1)
                ...
                .mandatoryWithLabel(Applicant::getAddressOverseas, "Is ${labelContentApplicantsOrApplicant1s} address outside of the UK?")
    ...
    private void buildApplicant2Fields(FieldCollectionBuilder<CaseData, State, EventBuilder<CaseData, UserRole, State>>
        ...
        fieldCollectionBuilder
            ...
            .complex(CaseData::getApplicant2)
                ...
                .mandatoryWithLabel(Applicant::getAddressOverseas, "Is ${labelContentRespondentsOrApplicant2s} address outside of the UK?")
