...
@Slf4j
public class ConditionalOrderGrantedNotification implements ApplicantNotification {
    ...
    private final ConditionalOrderGrantedDocumentPack conditionalOrderGrantedDocumentPack;
