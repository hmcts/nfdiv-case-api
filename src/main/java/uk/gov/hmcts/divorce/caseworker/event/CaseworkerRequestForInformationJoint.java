...
@Component
public class CaseworkerRequestForInformationJoint implements CCDConfig<CaseData, State, UserRole> {
        ...
        new PageBuilder(configBuilder
            ...
            .complex(CaseData::getRequestForInformationList)
                .complex(RequestForInformationList::getRequestForInformation)
                    ...
                    .mandatory(RequestForInformation::getRequestForInformationName, "requestForInformationJointParties=\"other\"")
                    .mandatory(RequestForInformation::getRequestForInformationEmailAddress, "requestForInformationJointParties=\"other\"")
    ...
    public AboutToStartOrSubmitResponse<CaseData, State> aboutToStart(CaseDetails<CaseData, State> details) {
        ...
        log.info("{} aboutToStart callback invoked for Case Id: {}", CASEWORKER_REQUEST_FOR_INFORMATION_JOINT, details.getId());
