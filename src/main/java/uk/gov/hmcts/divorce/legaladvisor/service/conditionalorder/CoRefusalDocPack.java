...
public enum CoRefusalDocPack {
    ...
    CLARIFICATION_JS_PACK(
        ...
        "Awaiting clarification JS Application Letter pack has missing documents. "
            + "Expected documents with type {} , for Case ID: {}",
    ...
    CLARIFICATION_PACK(
        ...
        "Awaiting clarification Application Letter pack has missing documents. "
            + "Expected documents with type {} , for Case ID: {}",
        LetterType.AWAITING_CLARIFICATION_APPLICATION_LETTER_TYPE,
    ...
    public static CoRefusalDocPack coRefusalPackFromCaseData(CaseData caseData,
                                                             Applicant applicant) {
