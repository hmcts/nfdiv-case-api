...
public class SolicitorDraftGeneralApplicationApplicant2 implements CCDConfig<CaseData, State, UserRole> {

    private final GeneralApplicationDraftJourneyService generalApplicationDraftJourneyService;

    public static final String SOLICITOR_DRAFT_GEN_APP_APPLICANT2 = "solicitor-draft-general-application-app2";
    ...
    public void configure(final ConfigBuilder<CaseData, State, UserRole> configBuilder) {
        ...
        final List<CcdPageConfiguration> pages = asList(new GeneralApplicationD11Page1(CaseData::getApplicant2),
                new GeneralApplicationD11Page2(CaseData::getApplicant2, "applicant2"),
                new GeneralApplicationD11Page3(CaseData::getApplicant2, "applicant2"),
                new GeneralApplicationD11Page4(CaseData::getApplicant2),
    ...
    public AboutToStartOrSubmitResponse<CaseData, State> aboutToStart(final CaseDetails<CaseData, State> details) {
        ...
        log.info("{} about to start callback invoked for Case Id: {}", SOLICITOR_DRAFT_GEN_APP_APPLICANT2, details.getId());
    ...
    public AboutToStartOrSubmitResponse<CaseData, State> aboutToSubmit(final CaseDetails<CaseData, State> details,
        ...
        log.info("{} about to submit callback invoked for Case Id: {}", SOLICITOR_DRAFT_GEN_APP_APPLICANT2, details.getId());
        final CaseData data = details.getData();
    ...
    private PageBuilder addEventConfig(final ConfigBuilder<CaseData, State, UserRole> configBuilder) {
        ...
        return new PageBuilder(configBuilder
            .event(SOLICITOR_DRAFT_GEN_APP_APPLICANT2)
