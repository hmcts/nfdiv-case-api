...
public class Applicant2ServiceDetails implements CcdPageConfiguration {
    ...
    private static final String INVALID_APPLICANT_EMAIL_ERROR = "You have entered an invalid respondent email address. "
    ...
    private static final String INVALID_SOLICITOR_EMAIL_ERROR = "You have entered an invalid solicitor email address. "
        + "Please check the email and enter it again, before submitting the application.";
    private static final String IS_APPLICANT2_REPRESENTED = "applicant2SolicitorRepresented=\"Yes\"";
    private static final String IS_RESPONDENT_NOT_REPRESENTED =
        "applicant2SolicitorRepresented=\"No\" AND applicationType=\"soleApplication\"";
    private static final String IS_APPLICANT2_REPRESENTED_OR_NOT_REPRESENTED =
