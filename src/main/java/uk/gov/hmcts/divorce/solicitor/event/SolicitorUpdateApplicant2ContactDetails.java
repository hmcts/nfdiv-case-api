...
public class SolicitorUpdateApplicant2ContactDetails implements CCDConfig<CaseData, State, UserRole> {
    ...
    private final CcdPageConfiguration applicant2UpdateContactDetails;

    private final ProcessConfidentialDocumentsService confidentialDocumentsService;

    public SolicitorUpdateApplicant2ContactDetails(UpdateApplicant2ContactDetails applicant2UpdateContactDetails,
                                                   ProcessConfidentialDocumentsService confidentialDocumentsService) {
        this.applicant2UpdateContactDetails = applicant2UpdateContactDetails;
    ...
    public AboutToStartOrSubmitResponse<CaseData, State> aboutToSubmit(
        ...
        log.info("Callback invoked for {}", APPLICANT_UPDATE_APPLICANT2_CONTACT_DETAILS);
