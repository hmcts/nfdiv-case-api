...
public class SolicitorAmendDeemedServiceApplication implements CCDConfig<CaseData, State, UserRole> {
    ...
    public void configure(final ConfigBuilder<CaseData, State, UserRole> configBuilder) {
        ...
        final List<CcdPageConfiguration> pages = List.of(new AmendServiceApplicationActionPage(),
    ...
    public AboutToStartOrSubmitResponse<CaseData, State> aboutToStart(final CaseDetails<CaseData, State> details) {
        ...
        log.info("{} About to start callback invoked for Case Id: {}", SOLICITOR_AMEND_DEEMED_SERVICE_APPLICATION, details.getId());
