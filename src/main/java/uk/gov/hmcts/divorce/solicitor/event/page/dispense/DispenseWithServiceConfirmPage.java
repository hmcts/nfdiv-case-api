...
public class DispenseWithServiceConfirmPage implements CcdPageConfiguration {
    ...
    private static final String SERVICE_INFORMATION_PARAGRAPH = """
            ...
            To dispense with service means progressing the ${labelContentDivorceOrCivilPartnership} without serving the papers
            on the respondent. In most cases, the ${labelContentUnionType} cannot be completed without the respondent's knowledge.
            Therefore, dispensing with service is considered by the court to be a last resort.

            ## What you need to do ##

            You'll need to prove to the court that you have made every reasonable attempt to find the respondent or send papers to them,
            ...
            - applying to the court to search government records to find the respondent's current address if you think they're still
            in the UK
            - if known, asking their employer to deliver the documents to the respondent on your behalf

            If you know that the respondent is unaware of the applicant's whereabouts, you may need to request a search for a divorce
            decree absolute or a final order from the Central Family Court. This is to make sure they have not already divorced the
            applicant. It will cost £65 for every 10 year period you search, and you will need to search from the date the applicant
            and respondent last had contact.

            If you cannot show that you have tried everything you reasonably can to send the ${labelContentUnionType} papers to the
            respondent, it is likely that your application will be rejected.
