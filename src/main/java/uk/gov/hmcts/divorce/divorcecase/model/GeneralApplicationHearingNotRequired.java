...
public enum GeneralApplicationHearingNotRequired implements HasLabel {
    ...
    YES_PARTNER_AGREES_WITH_APPLICATION("Yes, because my partner agrees with my application"),

    @JsonProperty("yesPartnerAgreesWithNoHearing")
    YES_PARTNER_AGREES_WITH_NO_HEARING("Yes, because my partner agrees to this being dealt with without a hearing"),
