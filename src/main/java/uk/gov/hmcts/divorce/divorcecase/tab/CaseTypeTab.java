...
public class CaseTypeTab implements CCDConfig<CaseData, State, UserRole> {
    ...
    private void buildCaseFlagTab(ConfigBuilder<CaseData, State, UserRole> configBuilder) {
        configBuilder.tab("caseFlags", "Case Flags")
            ...
            .field(CaseData::getCaseFlags, "flagLauncher = \"ALWAYS_HIDE\"")
            .field("applicant1Flags", "flagLauncher = \"ALWAYS_HIDE\"")
            .field("applicant2Flags", "flagLauncher = \"ALWAYS_HIDE\"")
            .field("applicant1SolicitorFlags", "flagLauncher = \"ALWAYS_HIDE\"")
            .field("applicant2SolicitorFlags", "flagLauncher = \"ALWAYS_HIDE\"");
    }
