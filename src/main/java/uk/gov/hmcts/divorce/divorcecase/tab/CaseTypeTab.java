...
public class CaseTypeTab implements CCDConfig<CaseData, State, UserRole> {
    ...
    private void buildPaymentTab(ConfigBuilder<CaseData, State, UserRole> configBuilder) {
        configBuilder.tab("paymentDetailsCourtAdmin", "Payment")
            ...
            .field("applicant1HWFReferenceNumber", "applicationType=\"soleApplication\"")
            .field("applicant1HWFReferenceNumber", "applicationType=\"jointApplication\" AND applicant2HWFNeedHelp=\"Yes\"")
