...
public class ApplicationTab implements CCDConfig<CaseData, State, UserRole> {
    ...
    private void addApplicant1(final Tab.TabBuilder<CaseData, UserRole> tabBuilder) {
        tabBuilder
            ...
            .field("applicant1SolicitorAddressOverseas", "applicant1SolicitorRepresented!=\"No\" AND applicant1SolicitorAddressOverseas=\"Yes\"")
    ...
    private void addApplicant2(final Tab.TabBuilder<CaseData, UserRole> tabBuilder) {
        tabBuilder
            ...
            .field("applicant2SolicitorAddressOverseas", "applicant2SolicitorRepresented!=\"No\" AND applicant2SolicitorAddressOverseas=\"Yes\"")
