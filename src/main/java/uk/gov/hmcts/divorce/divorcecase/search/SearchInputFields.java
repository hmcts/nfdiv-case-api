...
public class SearchInputFields implements CCDConfig<CaseData, State, UserRole> {
    ...
    public static final List<SearchField<UserRole>> SEARCH_FIELD_LIST = of(
        ...
        SearchField.<UserRole>builder().label("Applicant address").id(APPLICANT_1_ADDRESS).build(),
        ...
        SearchField.<UserRole>builder().label("Respondent address").id(APPLICANT_2_ADDRESS).build(),
