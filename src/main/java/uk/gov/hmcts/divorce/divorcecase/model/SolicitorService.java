...
public class SolicitorService {
    ...
    private Set<StatementOfTruth> statementOfTruth;

    @Getter
    @AllArgsConstructor
    public enum StatementOfTruth implements HasLabel {

        @JsonProperty("Yes")
        CONFIRM("I believe that the facts stated in the application are true.");
