    ...
    public void run() {
        ...
        try {
            ...
            if (minimumCasesToProcess <= casesAwaitingPronouncement.size()) {
                ...
                Long bulkListCaseId = caseDetailsBulkCase.getId();

                updateCasesWithBulkListingCaseId(casesAwaitingPronouncement, bulkListCaseId, user, serviceAuth);
