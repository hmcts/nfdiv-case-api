...
public class SystemSendFinalOrderInsightSurvey implements CCDConfig<CaseData, State, UserRole> {
    ...
    public AboutToStartOrSubmitResponse<CaseData, State> aboutToSubmit(
        ...
        final LocalDate grantedDate = caseData.getFinalOrder().getGrantedDate().toLocalDate();
        final LocalDate earliestNotificationDate = grantedDate.plusDays(inviteStage.getDaysAfterGrantedDate());
