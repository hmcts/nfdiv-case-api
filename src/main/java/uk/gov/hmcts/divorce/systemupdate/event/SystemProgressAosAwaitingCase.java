...
@Component
public class SystemProgressAosAwaitingCase implements CCDConfig<CaseData, State, UserRole> {

    public static final String SYSTEM_PROGRESS_AWAITING_AOS = "system-progress-awaiting-aos";

    @Override
    public void configure(final ConfigBuilder<CaseData, State, UserRole> configBuilder) {
        new PageBuilder(configBuilder
            .event(SYSTEM_PROGRESS_AWAITING_AOS)
