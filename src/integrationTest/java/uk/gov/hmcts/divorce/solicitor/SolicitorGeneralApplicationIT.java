...
class SolicitorGeneralApplicationIT {
    ...
    @Test
    void shouldAddDocumentToDocumentsUploadedWhenGeneralApplicationSubmitted() throws Exception {
    ...
    @Test
    void shouldAddPaymentWhenGeneralApplicationSubmitted() throws Exception {
    ...
    @Test
    void shouldReturnErrorsIfCaseIsPartOfActiveBulkCase() throws Exception {
