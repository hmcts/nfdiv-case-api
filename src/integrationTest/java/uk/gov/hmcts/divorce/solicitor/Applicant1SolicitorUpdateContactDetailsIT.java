...
public class Applicant1SolicitorUpdateContactDetailsIT {
    ...
    void shouldValidateApplicant1SolicitorOrgAndReturnNoErrorsWhenSolicitorBelongsToSelectedOrg() throws Exception {
        ...
        final String jsonStringResponse = mockMvc.perform(MockMvcRequestBuilders.post(APP1_SOLICITOR_UPDATE_CONTACT_MID_EVENT_URL)
                .contentType(APPLICATION_JSON)
                .header(SERVICE_AUTHORIZATION, AUTH_HEADER_VALUE)
                .header(AUTHORIZATION, TEST_AUTHORIZATION_TOKEN)
                .content(objectMapper.writeValueAsString(callbackRequest(caseDataWithApplicant1Org(), APP1_SOLICITOR_UPDATE_CONTACT_DETAILS)))
    ...
    public void shouldValidateApplicant1SolicitorOrgAndReturnErrorWhenSolicitorDoesNotBelongsToSelectedOrg() throws Exception {
        ...
        final String jsonStringResponse = mockMvc.perform(post(APP1_SOLICITOR_UPDATE_CONTACT_MID_EVENT_URL)
                .contentType(APPLICATION_JSON)
                .header(SERVICE_AUTHORIZATION, AUTH_HEADER_VALUE)
                .header(AUTHORIZATION, TEST_AUTHORIZATION_TOKEN)
                .content(objectMapper.writeValueAsString(callbackRequest(caseDataWithApplicant1Org(), APP1_SOLICITOR_UPDATE_CONTACT_DETAILS)))
