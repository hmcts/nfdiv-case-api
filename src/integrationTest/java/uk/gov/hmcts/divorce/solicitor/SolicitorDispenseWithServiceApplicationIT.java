...
class SolicitorDispenseWithServiceApplicationIT {
    ...
    void shouldSetInterimApplicationTypeToDeemedServiceAndSubmitDraftFromInterimOptions() throws Exception {
        ...
        mockMvc.perform(post(ABOUT_TO_SUBMIT_URL)
                ...
                .content(objectMapper.writeValueAsString(callbackRequest(caseData, SOLICITOR_DISPENSE_WITH_SERVICE_APPLICATION)))
        ...
        assertThat(caseDataCaptor.getValue().getApplicant1().getInterimApplicationOptions().getInterimApplicationType())
            .isEqualTo(InterimApplicationType.DISPENSE_WITH_SERVICE);
    }
}
