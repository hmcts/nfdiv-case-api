...
class SolicitorAmendAlternativeServiceApplicationIT {
    ...
    @Test
    void shouldAmendAlternativeServiceApplication() throws Exception {
        ...
        mockMvc.perform(post(ABOUT_TO_SUBMIT_URL)
                ...
                .content(objectMapper.writeValueAsString(callbackRequest(caseData, SOLICITOR_AMEND_ALTERNATIVE_SERVICE_APPLICATION)))
    ...
    @Test
    void shouldWithdrawAlternativeServiceApplication() throws Exception {
        CaseData caseData = CaseData.builder()
            .applicant1(Applicant.builder()
                .interimApplicationOptions(InterimApplicationOptions.builder()
