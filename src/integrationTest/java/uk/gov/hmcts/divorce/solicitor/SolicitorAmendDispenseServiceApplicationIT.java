...
class SolicitorAmendDispenseServiceApplicationIT {
    ...
    void shouldAmendDeemedServiceApplication() throws Exception {
        ...
        mockMvc.perform(post(ABOUT_TO_SUBMIT_URL)
                ...
                .content(objectMapper.writeValueAsString(callbackRequest(caseData, SOLICITOR_AMEND_DISPENSE_WITH_SERVICE_APPLICATION)))
