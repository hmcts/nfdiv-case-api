...
class SolicitorAmendBailiffServiceApplicationIT {
    ...
    @Test
    void shouldAmendBailiffServiceApplication() throws Exception {
        ...
        mockMvc.perform(post(ABOUT_TO_SUBMIT_URL)
                ...
                .content(objectMapper.writeValueAsString(callbackRequest(caseData, SOLICITOR_AMEND_BAILIFF_SERVICE_APPLICATION)))
