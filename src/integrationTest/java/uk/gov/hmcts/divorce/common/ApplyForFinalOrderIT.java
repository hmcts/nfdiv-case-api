...
public class ApplyForFinalOrderIT {
    ...
    @Test
    void shouldSendEmailToApplicant1InAwaitingFinalOrderState() throws Exception {
    ...
    @Test
    void shouldSendEmailToApplicant2InAwaitingFinalOrderState() throws Exception {
    ...
    @Test
    void shouldNotSendEmailsToEitherApplicantInFinalOrderOverdueState() throws Exception {
        final CaseData data = caseData();
        data.setApplicationType(ApplicationType.SOLE_APPLICATION);
