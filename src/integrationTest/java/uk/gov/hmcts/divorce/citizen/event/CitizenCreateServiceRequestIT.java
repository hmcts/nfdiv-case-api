...
class CitizenCreateServiceRequestIT {
    ...
    @Test
    void givenCaseInAwaitingPaymentThenSetApplicationFeeServiceReference() throws Exception {
    ...
    @Test
    void givenCaseInAwaitingFinalOrderPaymentThenSetFinalOrderFeeServiceReference() throws Exception {
        var data = validApplicant1CaseData();
