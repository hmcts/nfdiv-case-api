...
public class AdminUnlinkApplicant1FromCaseIT {
    ...
    @Test
    public void shouldUnlinkApplicant1FromCase() throws Exception {
        stubForIdamDetails(TEST_AUTHORIZATION_TOKEN, SUPER_USER_USER_ID, SUPER_USER_ROLE);
        stubForIdamToken(TEST_AUTHORIZATION_TOKEN);
        CallbackRequest callbackRequest = callbackRequest(caseData(), ADMIN_UNLINK_APPLICANT_1);
        ...
        verify(ccdAccessService)
            .removeUsersWithRole(callbackRequest.getCaseDetails().getId(), List.of(CREATOR.getRole()));
    }
}
