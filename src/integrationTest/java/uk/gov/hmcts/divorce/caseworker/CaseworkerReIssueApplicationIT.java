...
public class CaseworkerReIssueApplicationIT {
    ...
    private static final String APP2_CONTACT_PRIVATE_CASEWORKER_REISSUE_APPLICATION_JS_ABOUT_TO_SUBMIT =
        "classpath:caseworker-reissue-application-sole-js-about-to-submit-respondent-response.json";
    ...
    private static final String NFD_NOP_R2_SOLE_APP2_CIT_OFFLINE_REISSUE_ID = "2ecb05c1-6e3d-4508-9a7b-79a84e3d63cc";
    ...
    void shouldSetReIssueDateAndGenerateDocumentsForSoleCitizenApplicationOfflineAos() throws Exception {
        ...
        stubForDocAssemblyWith(NOTICE_OF_PROCEEDING_TEMPLATE_ID, "FL-NFD-GOR-ENG-Notice-Of-Proceedings-AS1-V2.docx");
        stubForDocAssemblyWith(NFD_NOP_R2_SOLE_APP2_CIT_OFFLINE_ID, "FL-NFD-GOR-ENG-Notice-Of-Proceedings-R2-V8.docx");
    ...
    void shouldGenerateRespondentInvitationAndSetReIssueDateWhenRespondentIsRepresentedAndReissueTypeIsDigitalAos()
        ...
        stubForDocAssemblyWith(NOTICE_OF_PROCEEDING_ID, "FL-NFD-GOR-ENG-Notice-Of-Proceedings-AS1-V2.docx");
        stubForIdamDetails(TEST_AUTHORIZATION_TOKEN, CASEWORKER_USER_ID, CASEWORKER_ROLE);
        stubForIdamToken(TEST_AUTHORIZATION_TOKEN);
        stubForIdamDetails(TEST_SYSTEM_AUTHORISATION_TOKEN, SYSTEM_USER_USER_ID, SYSTEM_USER_ROLE);
        stubForIdamToken(TEST_SYSTEM_AUTHORISATION_TOKEN);
    ...
    void shouldGenerateRespondentAosAndSetReIssueDateWhenRespondentIsRepresentedAndTypeIsReissueCase()
        ...
        stubForDocAssemblyWith(AOS_COVER_LETTER_ID, "FL-NFD-GOR-ENG-Notice-Of-Proceedings-AS1-V2.docx");
        stubForDocAssemblyWith(MINI_APPLICATION_ID, TEST_DIVORCE_APPLICATION_SOLE_TEMPLATE_ID);
    ...
    @Test
    void shouldAddNOPDocumentsToDocumentsGeneratedForJudicialSeparationApplicant1() throws Exception {
        final CaseData caseData = validCaseDataForIssueApplication();
        ...
        stubForDocAssemblyWith(NFD_NOP_APP1_JS_SOLE_ID, "FL-NFD-GOR-ENG-Notice_Of_Proceedings_Applicant1_JS_Sole.docx");
        stubForDocAssemblyWith(APPLICANT_COVERSHEET_TEMPLATE_ID, "NFD_Applicant_Coversheet.docx");
        stubForDocAssemblyWith(NFD_NOP_APP2_JS_SOLE_ID, "FL-NFD-GOR-ENG-Notice-Of-Proceedings-R1-V6.docx");
        stubForDocAssemblyWith(APPLICANT_COVERSHEET_TEMPLATE_ID, "NFD_Applicant_Coversheet.docx");
        stubForDocAssemblyWith(DIVORCE_APPLICATION_TEMPLATE_ID, TEST_DIVORCE_APPLICATION_SOLE_TEMPLATE_ID);
        stubForDocAssemblyWith(NFD_NOP_R2_SOLE_APP2_CIT_OFFLINE_REISSUE_ID,
            "FL-NFD-GOR-ENG-Notice_Of_Proceedings_Respondent_ReIssue_Offline.docx");
        ...
        assertThatJson(response)
            .isEqualTo(json(TestResourceUtil.expectedResponse(APP2_CONTACT_PRIVATE_CASEWORKER_REISSUE_APPLICATION_JS_ABOUT_TO_SUBMIT)));
    }
    ...
    void shouldGenerateR2WelshNoticeOfProceedingsForRespondentIfRespondentLanguagePreferenceIsWelsh() throws Exception {
        ...
        stubForDocAssemblyWith(NOTICE_OF_PROCEEDING_TEMPLATE_ID, "FL-NFD-GOR-ENG-Notice-Of-Proceedings-AS2-V5.docx");
