...
import static uk.gov.hmcts.divorce.testutil.DocAssemblyWireMock.stubDFormsUpload;
...
public class CaseworkerIssueApplicationIT {
    ...
    void shouldIssueApplicationAndGenerateDocumentsForSoleCitizenApplicationWhenRespondentIsOverseasBased() throws Exception {
        ...
        stubForDocAssemblyWith(NOP_ONLINE_SOLE_RESP_TEMPLATE_ID, "FL-NFD-GOR-ENG-Notice-Of-Proceedings-Outside-England-Wales-R2-V2.docx");
        stubForDocAssemblyWith(DIVORCE_APPLICATION_TEMPLATE_ID, TEST_DIVORCE_APPLICATION_SOLE_TEMPLATE_ID);
    ...
    void shouldIssueApplicationAndGenerateDocumentsForJointApplication() throws Exception {
        ...
        stubForDocAssemblyWith(AOS_COVER_LETTER_TEMPLATE_ID, "FL-NFD-GOR-ENG-Notice-Of-Proceedings-AS1-V2.docx");
    ...
    void shouldGenerateOnlyDivorceApplicationAndSetIssueDateWhenSolicitorServiceMethod() throws Exception {
        ...
        stubForDocAssemblyWith(AOS_COVER_LETTER_TEMPLATE_ID, "FL-NFD-GOR-ENG-Notice-Of-Proceedings-AS2-V5.docx");
        stubForDocAssemblyWith(DIVORCE_APPLICATION_TEMPLATE_ID, TEST_DIVORCE_APPLICATION_SOLE_TEMPLATE_ID);
    ...
    @Test
    void shouldAddNOPDocumentsToDocumentsGeneratedForJudicialSeparation() throws Exception {
        final CaseData caseData = validCaseDataForIssueApplication();
        caseData.getApplication().setServiceMethod(PERSONAL_SERVICE);
        ...
        stubForDocAssemblyWith(AOS_COVER_LETTER_TEMPLATE_ID, "FL-NFD-GOR-ENG-Notice-Of-Proceedings-AL2.docx");
        stubForDocAssemblyWith(DIVORCE_APPLICATION_TEMPLATE_ID, TEST_DIVORCE_APPLICATION_SOLE_TEMPLATE_ID);
        stubForDocAssemblyWith(NFD_NOP_APP2_JS_SOLE_ID, "FL-NFD-GOR-ENG-Notice_Of_Proceedings_Paper_Respondent_JS.docx");
        stubForDocAssemblyWith(APPLICANT_COVERSHEET_TEMPLATE_ID, "NFD_Applicant_Coversheet.docx");
        ...
        stubForIdamDetails(TEST_SYSTEM_AUTHORISATION_TOKEN, SYSTEM_USER_USER_ID, SYSTEM_USER_ROLE);
        stubForIdamToken(TEST_SYSTEM_AUTHORISATION_TOKEN);
        stubDFormsUpload(documentUploadClientApi, D10, D10_DOCUMENT_ID);
        stubAosPackSendLetterToApplicant1NotCourtService(AOS_COVER_LETTER_TEMPLATE_ID, NFD_NOP_APP2_JS_SOLE_ID);
        ...
        assertThatJson(response)
            .isEqualTo(json(TestResourceUtil.expectedResponse(APP2_CONTACT_PRIVATE_CASEWORKER_ISSUE_APPLICATION_JS_ABOUT_TO_SUBMIT)));
    }
