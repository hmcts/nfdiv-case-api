...
public class PatchCase implements CcdConfiguration {
    ...
    public void applyTo(final ConfigBuilder<CaseData, State, UserRole> configBuilder) {
        ...
        configBuilder
            ...
            .optional(CaseData::getD8DerivedPetitionerHomeAddress)
            ...
            .optional(CaseData::getD8PetitionerNameDifferentToMarriageCert)
            ...
            .optional(CaseData::getPetitionerContactDetailsConfidential);
    }
}
